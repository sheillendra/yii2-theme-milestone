...
<div class="sidebar-panel">
    <div class="brand">
        ...
        <!-- logo -->
        <a class="brand-logo">
            <img class="expanding-hidden" src="<?php echo $milestoneAsset->baseUrl ?>/images/logo.png" alt=""/>
        </a>
        <!-- /logo -->
    </div>
    <div class="nav-profile dropdown">
        <a href="javascript:;" class="dropdown-toggle" data-toggle="dropdown">
            <div class="user-image">
                <img src="<?php echo $milestoneAsset->baseUrl ?>/images/avatar.jpg" class="avatar img-circle" alt="user" title="user"/>
            </div>
